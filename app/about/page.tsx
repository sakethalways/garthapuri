  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#faf8f5] via-[#fefdfb] to-[#faf8f5]">
      ...
      <section className="bg-gradient-to-b from-[#d4af37]/20 via-[#d4af37]/10 to-white/40 py-2 sm:py-3 md:py-4 lg:py-6">
        <div className="w-full px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 2xl:px-48">
          <div className="text-center space-y-1">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-['Playfair_Display'] font-bold text-[#8d3c02] mt-2 sm:mt-3">
              About Garthapuri
            </h1>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#8d3c02]/70 max-w-3xl mx-auto mt-1">
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="w-full px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 2xl:px-48">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-['Playfair_Display'] font-bold text-[#8d3c02] text-center mb-6 sm:mb-8 md:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            {[
              ...
              <div key={index} className="bg-white rounded-xl p-4 sm:p-5 md:p-6 shadow-md border border-[#d4af37]/20 hover:shadow-lg transition-shadow">
